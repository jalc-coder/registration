...
library(readxl)
spring <- read_excel("~/fall data comparison.xlsx")
comp<-read_excel("~/fall data comparison.xlsx", 
    sheet = "unduplicated")
...
te$`Percent Enrollment Change`<-percent(as.numeric(te$`Percent Change Headcount`, accuracy=0.1))
te<-te[,c(2,4,3,5:6)]
...
t<-t[,2:6]
t<-rbind(t, t.total)
colnames(t)<-c("Division", "H22", "H23", "Hour Difference", "Percent Hour Difference")
t$`Percent Hour Difference`<-as.numeric(t$`Percent Hour Difference`)
...
te
th
pivot_longer(sum.overview[,1:3], names_to = "Headcount", values_to = "number", cols = Headcount22:Headcount23) %>% ggplot(aes(x=Week, y=number, col=Headcount)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Headcount Comparision Fall 2022 to Fall 2023") + labs(x="Week", y="Headcount") + scale_color_discrete(labels=c("Headcount 2022", "Headcount 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())

```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(sum.overview[,c(1,4:5)], names_to = "Credits", values_to = "Number", cols = Hour22:Hour23) %>% ggplot(aes(x=Week, y=Number, col=Credits)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023") + labs(x="Week", y="Credit Hours") + geom_hline(yintercept = 30493, linetype="dashed", color="blue") + annotate("text", 1, 30500, vjust = 2, label = "Goal") + scale_y_continuous(breaks = seq(0,35000,by=5000)) + scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023')) + geom_point(x=21, y=30493, color="blue")+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
colnames(spring)<-c("Week", "Division", "E22", "H22", "E23", "H23", "Enrollment Diference", "Percent Change Headcount", "Hour Difference", "Percent Hour Difference")
...
ah<-kable(allied.headcount[1:current.week,], "latex", booktabs = TRUE, caption = paste("Course Enrollment of Allied Health for week", current.week, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header", "scale_down", "hold_position"))
ac<-kable(allied.hours[1:current.week,][1:current.week,], "latex", booktabs = TRUE, caption = paste("Credit Hours of Allied Health for week", current.week, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header", "scale_down", "hold_position"))
ah
ac
pivot_longer(allied.headcount[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=E22:E23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Course Enrollment Comparision Fall 2022 to Fall 2023", subtitle = "Allied Health") + labs(x="Week", y="Course Enrollment")+ scale_color_discrete(labels=c("Course Enrollment 2022", "Course Enrollment 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(allied.hours[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=H22:H23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023", subtitle = "Allied Health") + labs(x="Week", y="Credit Hours")+ scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023'))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
...
aph<-kable(applied.headcount[1:current.week,], "latex", booktabs = TRUE, caption = paste("Course Enrollment of Applied Technology for week", current.week, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header", "scale_down", "hold_position"))
apc<-kable(applied.hours[1:current.week,][1:current.week,], "latex", booktabs = TRUE, caption = paste("Credit Hours of Applied Technology for week", current.week, sep = " ")) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header", "scale_down", "hold_position"))
aph
apc
pivot_longer(applied.headcount[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=E22:E23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Course Enrollment Comparision Fall 2022 to Fall 2023", subtitle = "Applied Technology") + labs(x="Week", y="Course Enrollment")+ scale_color_discrete(labels=c("Course Enrollment 2022", "Course Enrollment 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(applied.hours[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=H22:H23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023", subtitle = "Applied Technology") + labs(x="Week", y="Credit Hours")+ scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023'))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
...
hh
hc
pivot_longer(hum.head[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=E22:E23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Course Enrollment Comparision Fall 2022 to Fall 2023", subtitle = "Humanities and Social Sciences") + labs(x="Week", y="Course Enrollment")+ scale_color_discrete(labels=c("Course Enrollment 2022", "Course Enrollment 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(hum.hours[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=H22:H23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023", subtitle = "Humanities and Social Sciences") + labs(x="Week", y="Credit Hours")+ scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023'))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
...
mh
mc
pivot_longer(mb.head[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=E22:E23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Course Enrollment Comparision Fall 2022 to Fall 2023", subtitle = "Business, Computer Science, and Math") + labs(x="Week", y="Course Enrollment")+ scale_color_discrete(labels=c("Course Enrollment 2022", "Course Enrollment 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(mb.hours[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=H22:H23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023", subtitle = "Business, Computer Science, and Math") + labs(x="Week", y="Credit Hours")+ scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023'))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
...
nh
nc
pivot_longer(nurse.head[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=E22:E23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Course Enrollment Comparision Fall 2022 to Fall 2023", subtitle = "Nursing") + labs(x="Week", y="Course Enrollment")+ scale_color_discrete(labels=c("Course Enrollment 2022", "Course Enrollment 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(nurse.hours[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=H22:H23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023", subtitle = "Nursing") + labs(x="Week", y="Credit Hours")+ scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023'))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
...
lh
lc
pivot_longer(ls.head[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=E22:E23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Course Enrollment Comparision Fall 2022 to Fall 2023", subtitle = "Life and Physical Science") + labs(x="Week", y="Course Enrollment")+ scale_color_discrete(labels=c("Course Enrollment 2022", "Course Enrollment 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(ls.hour[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=H22:H23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023", subtitle = "Life and Physical Science") + labs(x="Week", y="Credit Hours")+ scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023'))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
...
sh
sc
pivot_longer(si.head[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=E22:E23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Course Enrollment Comparision Fall 2022 to Fall 2023", subtitle = "SICCM") + labs(x="Week", y="Course Enrollment")+ scale_color_discrete(labels=c("Course Enrollment 2022", "Course Enrollment 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(si.hour[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=H22:H23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023", subtitle = "SICCM") + labs(x="Week", y="Credit Hours")+ scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023'))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
...
wh
wc
pivot_longer(wd.head[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=E22:E23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Course Enrollment Comparision Fall 2022 to Fall 2023", subtitle = "Workforce Development") + labs(x="Week", y="Course Enrollment")+ scale_color_discrete(labels=c("Course Enrollment 2022", "Course Enrollment 2023"))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
pivot_longer(wd.hour[,c(1,3:4)], names_to = "Year", values_to = "Number", cols=H22:H23) %>% ggplot(aes(x=Week, y=Number, col=Year)) + geom_point() + geom_line() + scale_x_continuous(breaks= seq(1,21, by=1)) + labs(title="Credit Hour Comparision Fall 2022 to Fall 2023", subtitle = "Workforce Development") + labs(x="Week", y="Credit Hours")+ scale_color_discrete(labels=c('Credit Hours 2022', 'Credit Hours 2023'))+ theme(legend.position="bottom", panel.grid.minor = element_blank())
```
